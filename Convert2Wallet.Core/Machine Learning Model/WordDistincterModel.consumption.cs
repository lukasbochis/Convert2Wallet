...
namespace Convert2Wallet_Core
{
    ...
    {
        /// <summary>
        /// model input class for WordDistincterModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for WordDistincterModel.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("WordDistincterModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("tag");
            if (labelColumn == null)
            {
                throw new Exception("tag column not found. Make sure the name searched for matches the name in the schema.");
            }
